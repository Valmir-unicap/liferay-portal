...
public class AMAttributeDistanceComparatorTest {
	...
	private <S, T> AdaptiveMedia<AMProcessor<FileVersion, AMProcessor>>
		_createAdaptiveMedia(
			AMAttribute<AMProcessor<FileVersion, AMProcessor>, S> amAttribute1,
			S value1,
			AMAttribute<AMProcessor<FileVersion, AMProcessor>, T> amAttribute2,
			T value2) {
	...
	private <T> AdaptiveMedia<AMProcessor<FileVersion, AMProcessor>>
		_createAdaptiveMedia(
			AMAttribute<AMProcessor<FileVersion, AMProcessor>, T> amAttribute,
			T value) {
