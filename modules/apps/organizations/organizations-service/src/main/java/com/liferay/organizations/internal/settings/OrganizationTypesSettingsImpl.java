...
public class OrganizationTypesSettingsImpl
	...
	public class OrganizationTypeConfigurationManagedServiceFactory
		...
		public void deleted(String pid) {
			String organizationTypeConfiguration = _stringStringHashMap.remove(
				pid);
		...
		public void updated(String pid, Dictionary<String, ?> dictionary)
			...
			_stringStringHashMap.put(pid, organizationTypeConfiguration.name());
		}
	...
	private final Map<String, OrganizationTypeConfiguration> _pidTypeMap =
		new HashMap<>();
	private final Map<String, String> _stringStringHashMap = new HashMap<>();
